...
public class TestPlotSoftPatterns
{
	...
	private static void setupPresetTests(Context context) {
	    ...
	    SelectTestFigureOptionListener selectTestFigureFourOptionListener = new SelectTestFigureOptionListener(FigureScript._4);
	    SelectTestFigureOptionListener selectTestFigureFiveOptionListener = new SelectTestFigureOptionListener(FigureScript._5);
		...
		context.addTest("Figure Joe 1 new", selectTestFigureFiveOptionListener);
	}
